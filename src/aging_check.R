...
params <- list(b1         = 1.99626,                            # mean seasonal transmission rate
               ...
               omega  = 1/353.187,                          # rate of loss of disease-induced/post-infection immunity
...
run_ode <- ode(y=state_initial_age, times = time_ode, func = rsv_model_age, parms = params, method = "ode23")
